...
# 📝 NotionClone — Block-Based Editor

A production-quality block editor inspired by Notion, built with modern React architecture.
</div>
...
<table>
  <tr>
    <td align="center" width="50%">
      <img src="./assets/Homepage.jpg" alt="Home / Workspace View" />
      <br />
      <sub><b>Workspace & Page Navigation</b></sub>
    </td>
    <td align="center" width="50%">
      <img src="./assets/Blockeditor.jpg" alt="Block Editor View" />
      <br />
      <sub><b>Block Editor</b></sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="50%">
      <img src="./assets/slash command.png" alt="Slash Command Menu" />
      <br />
      <sub><b>Slash Command Menu</b></sub>
    </td>
    <td align="center" width="50%">
      <img src="./assets/Drag and drop.png" alt="Drag and Drop Nesting" />
      <br />
      <sub><b>Drag & Drop Nesting</b></sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="50%">
      <img src="globalsearch.png" alt="Global Search Modal" />
      <br />
      <sub><b>Global Search</b></sub>
    </td>
    <td align="center" width="50%">
      <img src="./assets/lighdark theme.png" alt="Dark Mode" />
      <br />
      <sub><b>Dark / Light Theme</b></sub>
    </td>
  </tr>
</table>
...
This application demonstrates advanced frontend engineering concepts including complex state management, nested data structures, drag-and-drop interactions, real-time collaboration features, and offline-first persistence.
...
1. **Create a page** — Click the "New Page" button in the sidebar
2. **Add blocks** — Click in the editor and start typing, or type `/` for the command menu
3. **Nest blocks** — Use `Tab` to indent or drag blocks to nest them
4. **Reorder blocks** — Drag blocks up/down to rearrange
...
- Drag & drop from [dnd-kit](https://dndkit.com)
